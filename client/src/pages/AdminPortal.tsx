...
import { Shield, Users, Phone, DollarSign, TrendingUp, Settings, LogOut, BarChart3, Building2 } from "lucide-react";
        ...
        <div className="p-4 border-t border-gray-800">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <Badge variant="outline" className="text-xs border-emerald-500 text-emerald-400 mt-0.5">
                Admin
              </Badge>
            </div>
          </div>
...
function AdminOverview() {
  const { data: shopStats } = trpc.shop.list.useQuery(undefined, { retry: false });
  const { data: partnerStats } = trpc.partner.getProfile.useQuery(undefined, { retry: false, enabled: false });

  const cards = [
    { label: "Total Shops", value: shopStats?.length ?? "—", icon: Building2, color: "text-emerald-400" },
    { label: "Active Subscriptions", value: "—", icon: DollarSign, color: "text-blue-400" },
    { label: "Calls This Month", value: "—", icon: Phone, color: "text-purple-400" },
    { label: "Active Partners", value: "—", icon: Users, color: "text-amber-400" },
  ];
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-gray-400 text-sm mt-1">Baylio platform metrics and management</p>
      </div>
    ...
    return (
      <div className="min-h-screen bg-gray-950 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400 text-sm mb-6">Sign in to access the admin portal</p>
          <Button
    ...
    return (
      <div className="min-h-screen bg-gray-950 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400 text-sm mb-6">You don't have admin access to Baylio.</p>
          <Button variant="outline" className="border-gray-700 text-gray-300" onClick={() => { window.location.href = "/"; }}>
            Go to Main Site
          </Button>
        </div>
      </div>
