    ...
    <div className="min-h-screen bg-zinc-950 text-white">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <Badge
                variant="outline"
                className="ml-2 text-xs border-emerald-700 text-emerald-400 bg-emerald-500/10"
              >
                Partner Program
              </Badge>
            </div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 pt-20 pb-16 text-center">
          <Badge
            variant="outline"
            className="mb-6 border-emerald-700 text-emerald-400 bg-emerald-500/10 px-4 py-1.5 text-sm"
          >
            🚀 Founding Partner spots open — first 25 get Gold tier instantly
          </Badge>
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight mb-6 leading-tight">
            Earn <span className="text-emerald-400">20–30% recurring</span>
            <br />
            for every shop you refer
          </h1>
          <p className="text-lg sm:text-xl text-zinc-400 max-w-2xl mx-auto mb-10">
            Baylio is an AI receptionist that auto repair shops love. You refer
            them, they subscribe, you earn every month — forever. No selling
            required.
          </p>
      ...
      <section
        id="calculator"
        className="py-16 bg-zinc-900/50 border-y border-zinc-800/60"
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            ...
            <p className="text-zinc-400">
              See exactly what you'd earn based on your referrals
            </p>
          </div>
            ...
            <div className="space-y-6">
              <div>
                <label className="block text-sm font-medium text-zinc-300 mb-3">
                  Number of shops referred:{" "}
                  <span className="text-emerald-400 font-bold">{shops}</span>
                </label>
                <input
                  type="range"
                  min={1}
      ...
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            ...
            <p className="text-zinc-400">
              Your rate increases automatically as you refer more shops
            </p>
          </div>
              ...
              >
                {t.popular && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                    <Badge className="bg-amber-500 text-black text-xs font-bold px-3">
                      Most Popular
                    </Badge>
                  </div>
                )}
                ...
                <p
                  className={`text-4xl font-mono font-extrabold mb-1 ${t.accent}`}
                >
                  {t.rate}
                </p>
          ...
          <p className="text-center text-xs text-zinc-600 mt-4">
            + 5% network override when you recruit other partners. Tiers upgrade
            automatically.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-zinc-900/30 border-y border-zinc-800/40">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            ...
            <p className="text-zinc-400">
              No minimums, no contracts, no complicated rules
            </p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {FEATURES.map(f => (
              ...
              >
                <div
                  className={`h-10 w-10 rounded-lg ${f.bg} flex items-center justify-center mb-4`}
                >
      ...
      <section className="py-20 bg-gradient-to-b from-zinc-900/50 to-emerald-950/20 border-t border-zinc-800/40">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-zinc-400 text-lg mb-8">
            Join free in under 60 seconds. Your referral link is ready
            instantly. First 25 partners get Gold tier status automatically.
          </p>
          <Button
            size="lg"
          ...
          <p className="text-xs text-zinc-600 mt-4">
            No credit card. No minimum referrals. Cancel anytime.
          </p>
        </div>
      </section>
      ...
      <footer className="border-t border-zinc-800/60 py-6">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-zinc-600">
            © 2025 Baylio. All rights reserved.
          </p>
