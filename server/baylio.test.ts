...
vi.mock("./db", () => ({
  ...
  getMissedCallAuditById: vi.fn().mockResolvedValue({ id: 1, ownerId: 1, shopId: 1 }),
  getMissedCallAuditsByOwner: vi.fn().mockResolvedValue([]),
  ...
  markNotificationReadForUser: vi.fn().mockResolvedValue(undefined),
